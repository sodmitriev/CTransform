...
extern void transformation_replace_constructor(const char* symbols, size_t size, char replace, transformation_replace* this);
...
extern void transformation_replace_finalize(transformation_replace* this);
